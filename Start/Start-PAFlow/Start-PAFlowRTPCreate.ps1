...
$Uri = "https://prod-109.westeurope.logic.azure.com:443/workflows/6dcfc148196b468088cf9b15615ea1bc/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=U60hN3kD9ci5NvcNv6iiBuEaqCuj96H1x24pi5Niz0I"
$CSVPath = (Read-Host -Prompt 'path .csv')
