...
chrome.runtime.onMessage.addListener((request) => {
    ...
    // Check if the message is the tokens
    if (request.action === 'LocalStorage_Session_Retrieved') {
        // Send the tokens to the popup
        chrome.runtime.sendMessage({ action: 'Send_Tokens_To_Popup', tokens: request.LocalStorage_Session_Object });
    }
